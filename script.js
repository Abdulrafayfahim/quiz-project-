...
let questions = [
    ...
    {
        prompt: 'What does html stands for ________?',
        options: [
    ...
    {
        prompt: 'Who is making gthe web standards?',
        options: [
                 "mozilla",
                 "google",
                 "microsoft",
      ...
      { prompt: 'What is the correct HTML element for inserting a line break?',
        ...
        { prompt: 'The content of the page (such as your pictures, text, links) will show up here.',
            options:[
                      "head",
                      "style",
                      "body",
        ...
        { prompt: 'The default link color for hyperlinks:',
            options:[
                       "green",
                       "purple",
                       "blue",
